...
This repository is maintained with AI agents in the loop. Use this file as the first stop for Claude Code sessions.

Keep this file intentionally aligned with `AGENTS.md`. Duplication is preferred here so Claude Code can work from this file even when it does not load `AGENTS.md`.
